...
Summary(pl):	Motyw 9nome-Darmis dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
...
License:	GPL
Vendor:		Ãlvaro del Castillo
Group:		Themes
URL:		http://art.gnome.org/themes/gdm_greeter/241/
Requires:	%{name}

%description Barcelona
Theme 'Barcelona' by 'Ãlvaro del Castillo'.

%description Barcelona -l pl
Motyw 'Barcelona' autorstwa 'Ãlvaro del Castillo'.
...
Summary(pl):	Motyw Colorado_Windmill dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
...
Summary(pl):	Motyw Crystal_For_GNOME dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Keifer
Group:		Themes
...
Summary(pl):	Motyw Crystal_for_GNOME_-_theme_2 dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
...
Summary(pl):	Motyw GDM_Waves dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Marco
Group:		Themes
...
License:	GPL
Vendor:		AndrÃ©s "Death_Knight" VillagrÃ¡n
Group:		Themes
URL:		http://art.gnome.org/themes/gdm_greeter/294/
Requires:	%{name}

%description Gnome_Chile
Theme 'Gnome_Chile' by 'AndrÃ©s "Death_Knight" VillagrÃ¡n'. Author's
...
Motyw 'Gnome_Chile' autorstwa 'AndrÃ©s "Death_Knight" VillagrÃ¡n'.
...
Summary(pl):	Motyw GNOME_Plain_Swoosh_GDM_Theme dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
...
Summary(pl):	Motyw GNOME_Plain_Swoosh_GDM_Theme_TNG dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Michael Flaig
Group:		Themes
...
Summary(pl):	Motyw In_This_World dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
...
%description Leon
Theme 'Leon' by 'Ãlvaro del Castillo'. Author's comment for the
theme: Leon Spanish city.

%description Leon -l pl
Motyw 'Leon' autorstwa 'Ãlvaro del Castillo'. Komentarz autora do
motywu: Leon Spanish city.

%package Linux_Crystal
Summary:	Theme Linux_Crystal for gdm (GNOME Display Manager)
Summary(pl):	Motyw Linux_Crystal dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Hayl (D K D)
Group:		Themes
...
Summary(pl):	Motyw Luna_GDM_Theme dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
...
Summary(pl):	Motyw M-83 dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Nexxuz
Group:		Themes
...
Summary(pl):	Motyw ManzanaTux dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Rogelio DomÃ­nguez HernÃ¡ndez
Group:		Themes
URL:		http://art.gnome.org/themes/gdm_greeter/747/
Requires:	%{name}

%description ManzanaTux
Theme 'ManzanaTux' by 'Rogelio DomÃ­nguez HernÃ¡ndez'. Author's
...
Motyw 'ManzanaTux' autorstwa 'Rogelio DomÃ­nguez HernÃ¡ndez'.
...
Summary(pl):	Motyw ManzanaTuxBlack dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Rogelio DomÃ­nguez HernÃ¡ndez
Group:		Themes
...
Theme 'ManzanaTuxBlack' by 'Rogelio DomÃ­nguez HernÃ¡ndez'. Author's
comment for the theme: Theme based in Crystal Theme by Niek van der
Maas. All icons are made by Everaldo - http://www.everaldo.com/. The
background is by Bandar Raffa - http://www.sadeem.net/tux.html ).

%description ManzanaTuxBlack -l pl
Motyw 'ManzanaTuxBlack' autorstwa 'Rogelio DomÃ­nguez HernÃ¡ndez'.
Komentarz autora do motywu: Theme based in Crystal Theme by Niek van
der Maas. All icons are made by Everaldo - http://www.everaldo.com/ .
The background is by Bandar Raffa - http://www.sadeem.net/tux.html ).
...
%description Murcia
Theme 'Murcia' by 'Ãlvaro del Castillo'. Author's comment for the
theme: Murcia Spanish city.

%description Murcia -l pl
Motyw 'Murcia' autorstwa 'Ãlvaro del Castillo'. Komentarz autora do
...
Summary(pl):	Motyw Peppe_for_Gonme dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Peppe
Group:		Themes
...
Summary(pl):	Motyw Shapy dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		T.Thiessens
Group:		Themes
...
Summary(pl):	Motyw Simple-GNOME-Logo dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
...
Summary(pl):	Motyw SpreadFirefox dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		DekuHaze
Group:		Themes
...
Summary(pl):	Motyw SVG_Sakura dla gdm (Zarz±dcy ekranów GNOME)
License:	GPL
Vendor:		Ben
Group:		Themes
...
Theme 'Valladolid' by 'Ãlvaro del Castillo'. Author's comment for
the theme: Valladolid Spanish city.

%description Valladolid -l pl
Motyw 'Valladolid' autorstwa 'Ãlvaro del Castillo'. Komentarz autora
